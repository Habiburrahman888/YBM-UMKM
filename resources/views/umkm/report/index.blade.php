                                    ...
                                    @foreach ($items as $i => $umkm)
                                        <tr class="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td class="px-4 sm:px-6 py-4 text-center">
                                                <a href="{{ route('umkm.report.single', $umkm->uuid) }}" target="_blank" class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-red-50 hover:bg-red-100 text-red-600 transition-colors">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @foreach ($mobileItems as $i => $umkm)
                        <div>
                            ...
                            <div class="px-4 py-4 hover:bg-gray-50/60 transition-colors cursor-pointer"
                                    ...
                                    {{-- Tombol PDF --}}
                                    <a href="{{ route('umkm.report.single', $umkm->uuid) }}" target="_blank"
