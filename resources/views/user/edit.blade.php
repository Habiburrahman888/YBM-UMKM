    ...
    <div class="space-y-4 sm:space-y-6">
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-card border border-gray-100 overflow-hidden animate-slide-up">
            <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                <h2 class="text-base sm:text-lg font-semibold text-gray-900">Edit User</h2>
                <p class="text-xs sm:text-sm text-gray-500 mt-1">Perbarui informasi user</p>
            </div>
            ...
            <form action="{{ route('user.update', $user->uuid) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="space-y-4 sm:space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex items-start gap-4">
                            <div id="avatar-preview"
                                ...
                                @if ($user->foto_profil)
                                    <img id="avatar-image" src="{{ asset('storage/' . $user->foto_profil) }}" alt="Preview"
                                        class="absolute inset-0 h-full w-full object-cover rounded-full">
                                    <svg id="avatar-placeholder" class="hidden w-10 h-10 text-gray-400" fill="none"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="mt-1 text-xs text-gray-500">JPG, PNG, WEBP (Maks. 2MB) - Kosongkan jika tidak
                                    ingin mengubah</p>
                                @error('foto_profil')
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Minimal 8 karakter (opsional)</p>
                        @error('password')
                            <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
