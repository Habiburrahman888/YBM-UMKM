                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                        ...
                        <div id="search-container" class="transition-all duration-300"
                            ...
                            <form method="GET" action="{{ route('admin.unit.index') }}" id="search-form"
                                ...
                                <div class="flex items-center">
                                    ...
                                    @if (request('q'))
                                        <a href="{{ route('admin.unit.index', request()->except('q')) }}"
                    ...
                    <form method="GET" action="{{ route('admin.unit.index') }}">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 items-end">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                @if (request()->hasAny(['provinsi', 'kota', 'status']))
                                    <a href="{{ route('admin.unit.index', request()->only('q')) }}"
                                        ...
                                        <div class="dropdown-wrapper">
                                            ...
                                            <div id="menu-{{ $unit->uuid }}" class="dropdown-menu">
                                                <div class="py-1">
                                                    ...
                                                    {{-- Edit --}}
                                                    <a href="{{ route('admin.unit.edit', $unit->uuid) }}"
