...
@push('styles')
    <link
        href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700;800;900&family=DM+Serif+Display:ital@0;1&display=swap"
        rel="stylesheet">
    <style>
        /* ════════════════════════════════════════════════
           DESIGN TOKENS
        ...
        *::after {
        ...
        .anim-2 {
            animation: fadeUp .5s .1s var(--ease-spring) both;
        }

        .anim-3 {
            animation: fadeUp .5s .2s var(--ease-spring) both;
        }

        .anim-4 {
            animation: fadeUp .5s .3s var(--ease-spring) both;
        }
        ...
        @media (max-width: 1024px) {
            ...
            .sidebar-col {
                position: static;
                order: -1;
                /* contact card moves above product list on mobile */
            }
...
@section('content')
    ...
    <div class="mobile-cta" aria-label="Kontak mobile">
        <div class="mobile-cta-inner">
            @if ($waNum ?? false)
                <a href="https://wa.me/{{ $waNum }}" target="_blank" rel="noopener noreferrer" class="btn-wa">
                    <i class="fab fa-whatsapp" aria-hidden="true"></i>
                    Chat WhatsApp
                </a>
                <a href="tel:{{ $umkm->telepon }}" class="btn-call" aria-label="Telepon">
