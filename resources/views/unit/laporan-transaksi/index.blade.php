...
@section('title', 'Laporan Transaksi Unit')
...
<div class="space-y-5">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-lg font-semibold text-gray-900">Laporan Transaksi - {{ $unit->nama_unit }}</h1>
            <p class="text-xs text-gray-500 mt-0.5">Rekap pendapatan mitra UMKM binaan unit Anda</p>
        </div>
        ...
        <div class="stat-card bg-white rounded-2xl p-5 border border-gray-100 shadow-card">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1.5">Memiliki transaksi</p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-card p-5">
            <h3 class="text-sm font-semibold text-gray-900 mb-4">Tren Pendapatan Unit (6 Bulan Terakhir)</h3>
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-card p-5">
            <h3 class="text-sm font-semibold text-gray-900 mb-4">Top 5 UMKM Anda</h3>
            @php
        ...
        <div class="px-5 py-4 border-b border-gray-100">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <button type="button" onclick="toggleFilter()"
                    ...
                    Filter
                    @if(request()->hasAny(['umkm_id','dari','sampai']))
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-100">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-5 py-3.5 text-left text-xs font-medium text-gray-500 uppercase tracking-wider w-10">No</th>
                        <th class="px-5 py-3.5 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">UMKM</th>
                        <th class="px-5 py-3.5 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Kategori</th>
                        <th class="px-5 py-3.5 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Transaksi</th>
                        <th class="px-5 py-3.5 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">Total Penjualan</th>
                    </tr>
                </thead>
                <tbody class="bg-white divide-y divide-gray-50">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    @else
                                        <div class="w-9 h-9 rounded-lg bg-blue-50 flex items-center justify-center">
                                            <span class="text-xs font-bold text-blue-600">{{ strtoupper(substr($row->nama_usaha, 0, 1)) }}</span>
                                        </div>
                                    @endif
                                    <div>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-5 py-12 text-center text-gray-400 italic">Belum ada data transaksi.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
