...
@section('content')
    <div class="h-full overflow-y-auto p-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
            ...
            @else
                <div
                    class="flex flex-col items-center justify-center h-64 bg-blue-50 rounded-xl border border-dashed border-blue-100">
                    <svg class="w-14 h-14 text-blue-200 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                            d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                    <p class="text-sm text-gray-500 font-medium">Belum ada data lokasi UMKM</p>
                    <p class="text-xs text-gray-400 mt-1">Lokasi akan muncul setelah UMKM memiliki kode provinsi</p>
                </div>
            @endif
        </div>

        <!-- Statistics Cards Row 1 & 2 -->
