    ...
    <div class="h-full overflow-y-auto p-6">
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500 mt-1">
                Selamat datang,
                <span class="font-semibold text-gray-700">{{ auth()->user()->name ?? auth()->user()->username }}</span>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
            ...
            <div class="bg-white rounded-xl p-5 hover:shadow-sm transition-shadow">
                <div class="mb-3">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" style="color:#ca8a04">
                        <path fill-rule="evenodd"
                            d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z"
                            clip-rule="evenodd" />
                    </svg>
                </div>
                <h3 class="text-2xl font-bold text-gray-900 mb-0.5">{{ $quickStats['pesanan_pending'] }}</h3>
                <p class="text-xs text-gray-400">Pesanan Pending</p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-2 max-h-96 overflow-y-auto custom-scrollbar">
                    @forelse($produkTerbaru as $produk)
                        <div
                            class="p-3.5 bg-gray-50 rounded-lg border border-gray-100 hover:border-gray-200 transition-colors group">
                            <div class="flex items-center gap-3">
                                <div class="w-11 h-11 rounded-lg overflow-hidden bg-white border border-gray-100 shrink-0">
                    ...
                    @empty
                        <div
                            ...
                            <p class="text-sm text-gray-400 mb-4">Belum ada produk terdaftar</p>
                ...
                <div class="divide-y divide-gray-100">
                    ...
                    <div class="flex items-center justify-between py-3">
                        ...
                        <span
                            ...
                            {{ $umkmSummary['status'] === 'aktif' ? 'bg-[#edf3f6] text-[#5b8fa8]' : 'bg-[#faf0ee] text-[#c47f6e]' }}">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 lg:col-span-2">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        ...
                        @if ($umkm->instagram)
                            <a href="{{ $umkm->instagram }}" target="_blank"
                                class="flex items-center gap-2.5 p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-gray-200 hover:shadow-sm transition-all group">
                                <div
                                    class="w-9 h-9 bg-gradient-to-br from-pink-400 to-purple-500 rounded-lg flex items-center justify-center shrink-0">
                        ...
                        @if ($umkm->facebook)
                            <a href="{{ $umkm->facebook }}" target="_blank"
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs font-semibold text-gray-700">Facebook</p>
                                    <p class="text-xs text-gray-400">Terhubung</p>
                                </div>
                            </a>
                        @endif
                        ...
                        @if ($umkm->youtube)
                            <a href="{{ $umkm->youtube }}" target="_blank"
                                ...
                                <div class="min-w-0">
                                    <p class="text-xs font-semibold text-gray-700">YouTube</p>
                                    <p class="text-xs text-gray-400">Terhubung</p>
                                </div>
                            </a>
                        @endif
                ...
                @else
                    <div
                        ...
                        <p class="text-sm text-gray-400 mb-3">Belum ada media sosial terhubung</p>
                        <a href="{{ route('umkm.settings.edit') }}"
                            class="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-semibold text-white bg-blue-600 hover:bg-blue-700 rounded-xl transition-colors">
                            Tambah Media Sosial
                        </a>
